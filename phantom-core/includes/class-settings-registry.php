...
class Settings_Registry {
	...
	public static function get_css_var_map(): array {
		return array(
			...
			'button_hover_bg'              => '--button-bg-hover',
			'button_hover_text_color'      => '--button-text-hover',
			'input_bg'                     => '--input--bg',
			...
			'announcement_bar_color'       => '--announcement-bar-color',
	...
	public static function get_px_keys(): array {
		return array(
			...
			'header_padding', 'header_padding_x', 'header_padding_y',
			'header_border_width', 'header_mobile_height',
			'footer_padding', 'gap', 'column_gap', 'row_gap',
			...
			'submenu_width', 'article_padding', 'widget_padding', 'widget_spacing',
			'divider_width', 'container_gutter', 'content_gap',
			...
			'boxed_width', 'layout_columns', 'banner_height',
