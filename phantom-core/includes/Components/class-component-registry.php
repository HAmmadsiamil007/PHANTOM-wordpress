    ...
    public function register_defaults(): void {
        $defaults = [
            ...
            'blog_card' => [
                ...
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Displays a blog post with image, category, date, title, and excerpt in card layout.',
                'dependencies' => ['phantom-core'],
            ],
            'cart_item' => [
                'name' => 'cart_item',
                ...
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Single cart item row with image, title, price, quantity controls, and subtotal.',
                'dependencies' => ['phantom-core'],
                'required_features' => ['woocommerce'],
            ],
            'checkout_item' => [
                ...
                'label' => 'Checkout Item',
                'category' => 'shop',
                'class_name' => 'PhantomCore\\Renderer\\Checkout_Item',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Checkout review item with image, meta, price, and subtotal.',
                'dependencies' => ['phantom-core'],
                'required_features' => ['woocommerce'],
            ],
            'checkout_form' => [
                ...
                'label' => 'Checkout Form',
                'category' => 'shop',
                'class_name' => 'PhantomCore\\Renderer\\Checkout_Form',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Multi-section checkout form with billing, shipping, and payment fields.',
                'dependencies' => ['phantom-core'],
                'required_features' => ['woocommerce'],
            ],
            'order_card' => [
                ...
                'label' => 'Order Card',
                'category' => 'shop',
                'class_name' => 'PhantomCore\\Renderer\\Order_Card',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Order summary card with number, status, date, total, and item count.',
                'dependencies' => ['phantom-core'],
                'required_features' => ['woocommerce'],
            ],
            'order_table' => [
                ...
                'label' => 'Order Table',
                'category' => 'shop',
                'class_name' => 'PhantomCore\\Renderer\\Order_Table',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Full order detail with item table and totals breakdown.',
                'dependencies' => ['phantom-core'],
                'required_features' => ['woocommerce'],
            ],
            'account_detail' => [
                ...
                'category' => 'account',
                'class_name' => 'PhantomCore\\Renderer\\Account_Detail',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'User account details with avatar, name, email, and phone.',
                'dependencies' => ['phantom-core'],
            ],
            'account_form' => [
                'name' => 'account_form',
                'label' => 'Account Form',
                'category' => 'account',
                'class_name' => 'PhantomCore\\Renderer\\Account_Form',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Editable account profile form with name, email, and phone fields.',
                'dependencies' => ['phantom-core'],
            ],
            'address_card' => [
                'name' => 'address_card',
                'label' => 'Address Card',
                'category' => 'account',
                'class_name' => 'PhantomCore\\Renderer\\Address_Card',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Single address display with type badge, full address, and action buttons.',
                'dependencies' => ['phantom-core'],
            ],
            'address_form' => [
                'name' => 'address_form',
                'label' => 'Address Form',
                'category' => 'account',
                'class_name' => 'PhantomCore\\Renderer\\Address_Form',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Address form with all fields for adding or editing an address.',
                'dependencies' => ['phantom-core'],
            ],
            'post_card' => [
                'name' => 'post_card',
                'label' => 'Post Card',
                'category' => 'content',
                'class_name' => 'PhantomCore\\Renderer\\Post_Card',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Blog post card with image, category, date, title, and excerpt.',
                'dependencies' => ['phantom-core'],
            ],
            'post_content' => [
                'name' => 'post_content',
                'label' => 'Post Content',
                'category' => 'content',
                'class_name' => 'PhantomCore\\Renderer\\Post_Content',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Full single post layout with title, meta, featured image, body, tags, and share.',
                'dependencies' => ['phantom-core'],
            ],
            'comment_card' => [
                'name' => 'comment_card',
                'label' => 'Comment Card',
                'category' => 'content',
                'class_name' => 'PhantomCore\\Renderer\\Comment_Card',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Single comment with avatar, author, date, content, reply button, and nested replies.',
                'dependencies' => ['phantom-core'],
            ],
            'search_card' => [
                'name' => 'search_card',
                'label' => 'Search Card',
                'category' => 'content',
                'class_name' => 'PhantomCore\\Renderer\\Search_Card',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Search result card with type icon, title, excerpt, and meta.',
                'dependencies' => ['phantom-core'],
            ],
            'nav_menu' => [
                'name' => 'nav_menu',
                ...
                'category' => 'layout',
                'class_name' => 'PhantomCore\\Renderer\\Nav_Menu',
                'version' => '1.0.0',
                'author' => 'Phantom Core',
                'description' => 'Navigation menu with ARIA label and menu item list.',
                'dependencies' => ['phantom-core'],
            ],
        ];
