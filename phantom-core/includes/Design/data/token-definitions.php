...
return [
    ...
    'typography.heading.spacing' => [
        ...
        'default' => '0', 'option_key' => 'phantom_typography_heading_spacing',
        'description' => 'Heading letter spacing',
    ],
    'typography.body.font' => [
        'name' => 'typography.body.font', 'category' => 'typography', 'type' => 'font_family',
        'default' => "'Archivo', sans-serif", 'option_key' => 'phantom_typography_body_font',
        'description' => 'Body font family',
    ],
    'typography.body.weight' => [
        'name' => 'typography.body.weight', 'category' => 'typography', 'type' => 'select',
        'default' => '400', 'option_key' => 'phantom_typography_body_weight',
        'description' => 'Body font weight',
    ],
    'typography.body.style' => [
        'name' => 'typography.body.style', 'category' => 'typography', 'type' => 'select',
        'default' => 'normal', 'option_key' => 'phantom_typography_body_style',
        'description' => 'Body font style',
    ],
    'typography.body.size' => [
        'name' => 'typography.body.size', 'category' => 'typography', 'type' => 'font_size',
        'default' => '16px', 'option_key' => 'phantom_typography_body_font_size',
        'description' => 'Base font size',
    ],
    'typography.body.line_height' => [
        'name' => 'typography.body.line_height', 'category' => 'typography', 'type' => 'unitless',
        'default' => '1.6', 'option_key' => 'phantom_typography_body_line_height',
        'description' => 'Body line height',
    ],
    'typography.body.spacing' => [
        'name' => 'typography.body.spacing', 'category' => 'typography', 'type' => 'size',
        'default' => '0', 'option_key' => 'phantom_typography_body_spacing',
        'description' => 'Body letter spacing',
    ],
    'typography.h1.size' => ['name' => 'typography.h1.size', 'category' => 'typography', 'type' => 'font_size', 'default' => '48px', 'option_key' => 'phantom_typography_h1_font_size', 'description' => 'H1 font size'],
    'typography.h2.size' => ['name' => 'typography.h2.size', 'category' => 'typography', 'type' => 'font_size', 'default' => '36px', 'option_key' => 'phantom_typography_h2_font_size', 'description' => 'H2 font size'],
    'typography.h3.size' => ['name' => 'typography.h3.size', 'category' => 'typography', 'type' => 'font_size', 'default' => '28px', 'option_key' => 'phantom_typography_h3_font_size', 'description' => 'H3 font size'],
    'typography.h4.size' => ['name' => 'typography.h4.size', 'category' => 'typography', 'type' => 'font_size', 'default' => '24px', 'option_key' => 'phantom_typography_h4_font_size', 'description' => 'H4 font size'],
    'typography.h5.size' => ['name' => 'typography.h5.size', 'category' => 'typography', 'type' => 'font_size', 'default' => '20px', 'option_key' => 'phantom_typography_h5_font_size', 'description' => 'H5 font size'],
    'typography.h6.size' => ['name' => 'typography.h6.size', 'category' => 'typography', 'type' => 'font_size', 'default' => '16px', 'option_key' => 'phantom_typography_h6_font_size', 'description' => 'H6 font size'],
    ...
    'effect.glow' => ['name' => 'effect.glow', 'category' => 'effect', 'type' => 'shadow', 'default' => '0 0 20px rgba(200,149,108,0.3)', 'option_key' => 'phantom_effect_glow', 'description' => 'Glow effect'],
    ...
    'component.input.focus' => ['name' => 'component.input.focus', 'category' => 'component', 'type' => 'color', 'default' => '#C8956C', 'option_key' => 'phantom_component_input_focus', 'description' => 'Input focus border color'],
